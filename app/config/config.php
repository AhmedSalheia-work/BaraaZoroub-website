...
defined('DATABASE_USER_NAME')? null : define('DATABASE_USER_NAME','root'); //progwlfo_baraa
defined('DATABASE_PASSWORD')? null : define('DATABASE_PASSWORD',''); //baraa@prography.co
