    ...
    <div class="header-top ">
        <div class=" container h-100">
            <div class="row  ">
                ...
                <?= isset($_SESSION['admin'])&& explode(' ',str_replace(['\\','/'],' ',str_replace(array('D:\xampp\BaraaZoroub-website\app\config\..\views\\','/home/progwlfo/baraazoroub.com/app/config/../views/'),'',$this->_action_view)))[0] === 'dashboard' && $_SESSION['admin'] === 'admin' ? '
