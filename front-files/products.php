...
<body >
    ...
    <div class="product-page">
             <section class="section-1 mb-5"></section>
            ...
            <section class="section-3">
                ...
                <div class="project mb-3">
                    ...
                    <img src="uploads/project1.png" alt="project_img" class="img-fluid vh-100  w-100" title="project" >
                </div>
                    <div class="project mb-3">

                        <img src="uploads/project1.png" alt="project_img" class="img-fluid w-100 vh-100 " title="project" >
                    </div>
                    <div class="project mb-3">

                        <img src="uploads/project3.png" alt="project_img" class="img-fluid w-100 min-vh-100" title="project" >
                    </div>
                </div>
            </section>
